...
//           // Create a combined array of unique values and custom options (if applicable)
//           let combinedUniqueValues = [...uniqueValues];

//           // Example: if type is "approvefunding" and the column is "status",
//           // then add custom options ["manual_funding", "paper"] if not already present.
//           if (col === "type" && type === "approvefunding") {
//             const customOptions = ["MANUAL_FUNDING", "PAYOUT","FUND"];
