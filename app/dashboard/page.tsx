...
//       number: requestForQuotationSubmitted?.requestForQuotationSubmitted,
//       permisssion: ["read_dashboards:request-for-quotation-submitted"],
//       path: "/dashboard",
//     },
//     {
//       title: "Request for Quotation (Awaiting Approval)",
//       number:
//         requestForQuotationAwaitingApproval?.requestForQuotationAwaitingApproval,
//       permisssion: ["read_dashboards:request-for-quotation-awaiting-approval"],
//       path: "/dashboard",
//     },
//     {
//       title: "Procurement Request (Submitted)",
//       number: procurementRequestSubmitted?.procurementRequestSubmitted,
//       permisssion: ["read_dashboards:procurement-request-submitted"],
//       path: "/dashboard",
//     },
//     {
//       title: "Procurement Request (Approved)",
//       number: procurementRequestApproved?.procurementRequestApproved,
//       permisssion: ["read_dashboards:procurement-request-approved"],
//       path: "/dashboard",
//     },
//     {
//       title: "Procurement Request (Awaiting PO/RFQ)",
//       number: procurementRequestAwaitingPoRfq?.procurementRequestAwaitingPoRfq,
//       permisssion: ["read_dashboards:procurement-request-awaiting-po-rfq"],
//       path: "/dashboard",
//     },
//     {
//       title: "Purchase Orders (Total Cost Value)",
//       number: purchaseOrdersTotalCost?.purchaseOrdersTotalCost,
//       permisssion: ["read_dashboards:purchase-orders-total-cost"],
//       path: "/dashboard",
//     },
//     {
//       title: "Work Orders (New)",
//       number: workOrdersNew?.workOrdersNew,
//       permisssion: ["read_dashboards:work-orders-new"],
//       path: "/dashboard",
//     },
//     {
//       title: "Work Orders (Awaiting Approval)",
//       number: workOrdersAwaitingApproval?.workOrdersAwaitingApproval,
//       permisssion: ["read_dashboards:work-orders-awaiting-approval"],
//       path: "/dashboard",
//     },
                    ...
                    <div
                      ...
                      className={`${
                        item.title === "Wallet Balance"
                          ? "bg-[#FBC2B6]"
                          : "bg-white"
                      } py-3 px-4 rounded-lg flex items-center justify-between cursor-pointe`}
                    >
                      {/* Left Content */}
                      <div className="relative">
                        {item.title !== "Wallet Balance" && (
